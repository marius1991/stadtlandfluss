...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { category: @solution.category, is_correct: @solution.is_correct, solution: @solution.solution }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { category: @solution.category, is_correct: @solution.is_correct, solution: @solution.solution }
    assert_redirected_to solution_path(assigns(:solution))
  end
